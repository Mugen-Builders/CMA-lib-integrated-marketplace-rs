...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let dapp_address_relay = String::from("0xF5DE34d6BbC0446E2a45719E718efEbaaE179daE");

    let list_price: u128 = 100_000_000_000_000_000_000;
    let mut storage = Storage::new(erc721_portal_address, erc20_portal_address, erc721_token, dapp_address_relay, erc20_token, list_price, ledger);
